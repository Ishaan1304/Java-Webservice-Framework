...
{
@Path("/add")
public Employee getEmployeeById(@RequestParameter("id") int id)
{
Employee employee;
System.out.println("-----getEmployeeById got called----");
return employee;
}
}
```
...
{
@Path("/get")
@SecuredAccess(checkPost="com.my.pack.secured.Security",guard="securityGuardOne")
public String get()
{
...
ss.setAttribute("name","Ishaan Gangrade");
